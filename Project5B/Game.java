...
public class Game {
   ...
   private void initializeGame() {
      ...
      // Here, cards get dealt out to each player in round-robin fashion, i.e.,
      ...
      for (int i = 0; i < players.length * handSize; i++) {
         players[i % players.length].getHand().addCard(draw()); //draw()
      }
